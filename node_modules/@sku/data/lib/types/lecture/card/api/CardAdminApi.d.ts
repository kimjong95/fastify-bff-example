...
import { AutoEncouragedCardQdo, AutoEncouragedCardRdo, Card, CardAdminCount, CardAdminQdo, CardByIdForAdminQdo, CardPolyglotUdo, CardSdo, CardWithAccessRuleResultRdo, CardWithContents, CardWithContentsAndRelatedCountRdo, DuplicateCardNameQdo } from '../model';
/**
 * 카드, 카드 내용, 관련 개수 조회
 * @param id
 */
 ...
 */
export declare function findByRdoWithAccessRuleResult_Admin(cardAdminQdo: CardAdminQdo, groupBasedAccessRuleToAccessCard: GroupBasedAccessRule): Promise<OffsetElementList<CardWithAccessRuleResultRdo>>;
/**
 ...
 */
export declare function modifyCardPolyglots_Admin(id: string, cardPolyglotUdo: CardPolyglotUdo): Promise<string>;
/**
 * 카드 승인 요청
 * @param id
 */
