...
import { BlendedChapter, Card, CardByIdQdo, CardCount, CardCountQdo, CardDiscussion, CardForUserViewByIdQdo, CardForUserViewRdo, CardFromCardBundleQdo, CardIdQdo, CardOrderBy, CardQdo, CardTypeAndCardCountRdo, CardWithContentsAndRelatedCountRdo, CardWithLearningContentCountRdo, CardWithPhaseCountForUserViewRdo, CardWithPhaseCountQdo, CardWithRelatedCountRdo, ChannelAndCardCountRdo, CollegeAndCardCountRdo, EnrollmentCardDetailQdo, EnrollmentCardDetailRdo, MigCardIdMapping, MyLearningRdo, PlaylistCardRdo, PlaylistCardWithProgressRdo, RecommendCardRdo, ScheduledLearningRdo } from '../model';
/**
 * 카드, 관련 개수 조회
 * @param id
 */
 ...
 * @param ids
 */
export declare function findCardForUserViewRdos(ids: string[], limit: number, sort?: 'Random' | ''): Promise<CardForUserViewRdo[]>;
/**
 ...
 * @param ids
 */
export declare function findMyCardProgress(ids: string[]): Promise<CardWithPhaseCountForUserViewRdo[]>;
/**
 ...
 * @param limit
 */
export declare function findEnrollingCards(excludeClosed: boolean, offset: number, limit: number): Promise<OffsetElementList<CardForUserViewRdo>>;
/**
 * 카드, 카드내용, 관련 개수 조회
 * @param id
 */
 ...
 * @param ids
 */
export declare function findIdNamesByIds(ids: string[]): Promise<IdPolyglotName[]>;
/**
 * 필수 카드 개수 조회
 */
 ...
 * @param limit
 */
export declare function findRequiredCards(limit?: number, home?: boolean): Promise<CardForUserViewRdo[]>;
/**
 * 검색 조건 카드번들 카드, 관련 개수 목록 조회(Get)
 * @param cardFromCardBundleQdo
 */
export declare function findByCardFromCardBundleRdo(cardFromCardBundleQdo: CardFromCardBundleQdo): Promise<CardWithRelatedCountRdo[]>;
/**
 ...
 * @param id
 */
export declare function findCardDiscussion(id: string): Promise<CardDiscussion>;
/**
 ...
 * @param blendedChpaterId
 */
export declare function findBlanedChapter(blendedChpaterId: string): Promise<BlendedChapter>;
