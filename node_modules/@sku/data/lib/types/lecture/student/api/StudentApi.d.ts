import { OffsetElementList, LearningState } from '../../../shared';
import { ExtraTaskType, MarkCompleteUdo, MyCardRelatedStudentsRdo, MySuniMediaRequestQdo, PaidCourseStudentRdo, Student, StudentAcceptOrRejectUdo, StudentApprovalAdminQdo, StudentCdo, StudentCount, StudentCountQdo, StudentHideUdo, StudentReportUdo, UserCardStudentQdo } from '../model';
/**
 * 학생 조회
 * @param id
 */
 ...
 */
export declare function registerHomework(studentId: string, fileBoxId: string, homeworkContent: StudentReportUdo): Promise<void>;
/**
 * 학생 신청 승인
 ...
 */
export declare function findPaidCourseStudent(studentApprovalAdminQdo: StudentApprovalAdminQdo): Promise<OffsetElementList<PaidCourseStudentRdo>>;
/**
