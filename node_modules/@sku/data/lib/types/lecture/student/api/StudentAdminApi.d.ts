import { CardRelatedStudentCdo, CardStudentQdo, CpLearningResultInCdo, CpLearningResultV2InCdo, CubeStudentQdo, HomeworkGradeUdo, MergeStudentResponse, PaidCourseStudentRdo, Student, StudentApprovalAdminQdo, StudentByAdminCdo, StudentLearningStateUdo, StudentRegisterByAdminResponse, StudentRemoveRequest, StudentRemoveResponse, StudentWithUserIdentity, UserCardRelatedStudentsRdo, UserStudentQdo } from '../model';
...
/**
 * 숙제 점수 입력
 * @param homeworkGradeUdo
 */
export declare function gradeHomeworkByOperator_Admin(homeworkGradeUdo: HomeworkGradeUdo): Promise<void>;
/**
 * 학생 삭제
 ...
 * @param qdo
 */
export declare function findPaidCourseStudent_Admin(qdo: StudentApprovalAdminQdo): Promise<OffsetElementList<PaidCourseStudentRdo>>;
